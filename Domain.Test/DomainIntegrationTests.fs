...
let private fiveCmd: MergeQueue.WorkflowTypes.Enqueue.Command =
    { number = 5555
      sha = "00005555"
...
let private sixCmd: MergeQueue.WorkflowTypes.Enqueue.Command =
    { number = 6666
      sha = "00006666"
      statuses = [ "circleci", "Success" ] }
...
let private sevenCmd: MergeQueue.WorkflowTypes.Enqueue.Command =
    { number = 7777
      sha = "00007777"
      statuses = [ "circleci", "Success" ] }
...
let private eightCmd: MergeQueue.WorkflowTypes.Enqueue.Command =
    { number = 8888
      sha = "00008888"
      statuses = [ "circleci", "Success" ] }
